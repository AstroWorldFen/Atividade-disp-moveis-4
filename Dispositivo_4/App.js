...
const imagensDestaque = [
  ...
  require("./assets/Duna arte.jpg"),
  require("./assets/Duna figurino.jpg"),
  require("./assets/Duna armas.jpg"),
  require("./assets/Duna arte1.jpg"),
  require("./assets/Duna arte2.jpg"),
  require("./assets/Duna atreides.jpg")
];
...
const elenco = [
  {
    ...
    papel: "Paul Atreides",
    imagem: require("./assets/Duna ator 1.jpg"),
    sexo: "Masculino",
  ...
  },
  {
    ...
    nome: "Zendaya",
    papel: "Chani",
    imagem: require("./assets/Duna ator 2.jpg"),
    sexo: "Feminino",
  ...
  },
  {
    ...
    papel: "Lady Jessica",
    imagem: require("./assets/Duna ator 3.jpg"),
    sexo: "Feminino",
  ...
  },
  {
    ...
    imagem: require("./assets/Duna ator 4.jpg"),
    sexo: "Masculino",
  ...
  },
  {
    ...
    nome: "Javier Bardem",
    papel: "Stilgar",
    imagem: require("./assets/Duna ator 5.jpg"),
    sexo: "Masculino",
  ...
  },
  {
    ...
    imagem: require("./assets/Duna ator 6.jpg"),
    sexo: "Masculino",
...
const filme = {
  ...
  imagem: require("./assets/Duna.jpg"),
    ...
    <View style={styles.container}>
      <ScrollView>
        ...
        <View style={styles.filtrosContainer}>
          ...
          <TextInput
            style={styles.input}
            placeholder="País de origem (simulado)"
            value={""}
          />
          <TextInput
            style={styles.input}
            placeholder="Frase famosa (simulado)"
            value={""}
          />
          ...
          <View style={styles.botoesContainer}>
            ...
            <TouchableOpacity style={styles.botao} onPress={() => alert("Filtros resetados!")}>
